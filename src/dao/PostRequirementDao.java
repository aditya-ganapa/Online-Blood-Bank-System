...
public class PostRequirementDao {
	public void post(PostRequirement postRequirement) {
		...
		try {
			PreparedStatement preparedStatement = connection.prepareStatement("insert into post_requirement(pr_state, pr_city, pr_pin_code, pr_blood_group, pr_user_id) values(?,?,?,?,?)");
			...
			preparedStatement.setInt(5, postRequirement.getUserId());
