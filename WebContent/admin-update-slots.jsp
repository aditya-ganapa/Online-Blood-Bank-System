...
<div id="slot-update-form-block">
	...
	<form name="slotUpdateForm" onsubmit="return validateSlotUpdateForm()" method="post" action="SlotUpdate">
		...
		<div class="form-field-name">Slot</div> : <input type="checkbox" name="morningSlot" id="morningSlot"/>9AM-12PM<br>
	 	<div class="form-field-name"> </div> &nbsp;  <input type="checkbox" name="afternoonSlot"/>12PM-3PM<br>
		<div class="form-field-name"> </div>   <input type="checkbox" name="eveningSlot"/>3PM-6PM<br><br>
